...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const sphere1Color: Albedo = { entityId: sphere1Id, color: { r: 210, g: 30, b: 30 } };
    ...
    const sphere2Color: Albedo = { entityId: sphere2Id, color: { r: 30, g: 30, b: 210 } };
    ...
    const sphere3Color: Albedo = { entityId: sphere3Id, color: { r: 50, g: 180, b: 70 } };
    ...
    this.components.albedos[lightId] = lightColor;
